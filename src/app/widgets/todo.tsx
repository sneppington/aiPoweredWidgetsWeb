...
export default function todoList({ mode }) {
    const todoWidget = useRef<HTMLDivElement>(null)

    useEffect(() => {
        todoWidget.current.querySelectorAll(".todo-element").forEach(element => {
            ...
            return (
                <div ref={todoWidget} className="widget-wrapper">
                    ...
                    <div className="content-todo">
                        <h1 className="todo-title">To <span className="color-theme">Do</span></h1>
